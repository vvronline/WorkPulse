...
async function handleChatMessage(
  ...
  if (msg.type === "chat_message") {
    ...
    // GROUP-CALL DECLINE — extracted to wsHandlers/huddles.ts (calls-module
    // separation: huddle ring-lifecycle logic must not interleave with the
    // 1:1 `call_*` handlers). Behaviour is unchanged.
