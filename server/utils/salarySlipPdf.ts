...
interface SalarySlipOptions {
    slip: SlipData;
    employee: EmployeeData;
    organization?: OrganizationData | null;
    branding?: BrandingData | null;
    ytdData?: YtdData | null;
    filename: string;
}
...
function getMonthYearLabel(slipMonth: string | null | undefined): string {
    if (!slipMonth) return "";
...
function sendSalarySlipPDF(res: Response, { slip, employee, organization, branding, ytdData, filename }: SalarySlipOptions): void {
    ...
    function detailRow(y: number, label: string, value: string | null | undefined, x: number): void {
