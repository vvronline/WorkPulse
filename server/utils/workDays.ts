 ...
 */
function isJsDowWorkDay(jsDow: number, workDaysSetOrValue?: Set<number> | string | null): boolean {
 ...
 */
function isWorkDay(date: Date, workDaysSetOrValue?: Set<number> | string | null): boolean {
