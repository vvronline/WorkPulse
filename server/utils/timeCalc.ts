 ...
 */
function computeFloorMs(entries: TimeEntry[], isLive = false): number {
    let floorMs = 0;
 ...
 */
function computeBreakMs(entries: TimeEntry[], isLive = false): number {
    let breakMs = 0;
 ...
 */
function computeDaySummary(entries: TimeEntry[], isLive = false): DaySummary {
...
export { tsToMs, computeFloorMs, computeBreakMs, computeDaySummary, computeStatus };