...
describe("Plan catalog integrity", () => {
    ...
    test("higher tiers never disable a feature that a lower tier has on", () => {
        ...
        const sorted = [...PLAN_KEYS].sort((a: any, b: any) => PLAN_RANK[a] - PLAN_RANK[b]);
...
describe("requireFeature middleware", () => {
    function runMiddleware(mw: any, req: any): Promise<any> {
        return new Promise((resolve) => {
            const res: any = {
                status(code: number) { this.statusCode = code; return this; },
                json(body: any) { this.body = body; resolve({ res: this, calledNext: false }); },
            };
