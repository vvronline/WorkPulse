...
exports.sendSalarySlipPDF = sendSalarySlipPDF;
...
function sendSalarySlipPDF(res, { slip, employee, organization, branding, ytdData, filename }) {
    ...
    const words = (0, numberToWords_1.amountToWords)(slip.net_pay, slip.currency || "INR");
    ...
    if (ytdData) {
        ...
        doc.font("Helvetica").fontSize(9).fillColor("#000000")
            .text(`Total Gross: ${formatCurrency(ytdData.totalGross, slip.currency)}   |   ` +
            `Total Deductions: ${formatCurrency(ytdData.totalDeductions, slip.currency)}   |   ` +
            `Total Net: ${formatCurrency(ytdData.totalNet, slip.currency)}`, ML, ytdY + 20);
        doc.y = ytdY + 40;
    }
    // ── FOOTER ──
    doc.moveDown(2);
...
//# sourceMappingURL=salarySlipPdf.js.map