...
exports.logPushCallLifecycle = logPushCallLifecycle;
/**
...
function requestLogger(req, res, next) {
    ...
    req.id = (Array.isArray(headerId) ? headerId[0] : headerId) || crypto_1.default.randomUUID();
...
function logPushCallLifecycle(event, level = "info") {
    logger[level]({
