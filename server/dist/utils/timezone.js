...
exports.getOffsetMin = getOffsetMin;
exports.getLocalToday = getLocalToday;
exports.getLocalYesterday = getLocalYesterday;
exports.getLocalDow = getLocalDow;
exports.getTzModifier = getTzModifier;
exports.getLocalDateFromTs = getLocalDateFromTs;
...
function clampOffset(raw) {
    ...
    if (isNaN(n)) {
        logger_1.logger.warn({ raw }, "Invalid timezone offset received — not a number");
        return 0;
    }
    if (n < -840 || n > 720) {
        logger_1.logger.warn({ offset: n }, "Timezone offset out of valid range (-840 to 720), rejecting");
        return null;
    }
    return n;
}
