...
const schema = {
     ...
     */
    str: ({ max = Infinity, min = 1, optional = false, pattern = null } = {}) => ({
        optional,
        validate(v) {
            if (v == null || v === "") {
                return optional
            ...
            if (pattern && !pattern.test(v))
                return { ok: false, error: "pattern-mismatch" };
            return { ok: true, value: v };
        },
    }),
    /** Positive integer (1, 2, 3, ...). Common for ids. */
    posInt: ({ optional = false } = {}) => ({
        optional,
        validate(v) {
            if (v == null) {
                return optional
    ...
    num: ({ min = -Infinity, max = Infinity, optional = false } = {}) => ({
        optional,
        validate(v) {
            if (v == null) {
                return optional
...
//# sourceMappingURL=wsValidate.js.map