...
router.get('/search', auth, loadUserContext, async (req: Request, res: Response) => {
    try {
...
router.get('/lookup/quicksearch', auth, loadUserContext, async (req: Request, res: Response) => {
    try {
