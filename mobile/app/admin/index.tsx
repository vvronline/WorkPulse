...
const SECTIONS: Section[] = [
  ...
  { key: "users", label: "Users", icon: Users, group: "People", route: "/admin/users" },
  { key: "add", label: "Add People", icon: UserPlus, group: "People", route: "/admin/add-people" },
  { key: "role-requests", label: "Role Requests", icon: RefreshCw, group: "People", route: "/admin/role-requests", badgeKey: "roleRequests" },
...
const GROUP_ORDER = ["Overview", "People", "Structure", "Settings", "Operations", "Compliance"];
...
export default function AdminPanel() {
  ...
  const refreshBadges = useCallback(() => {
    getRoleChangeRequests({ status: "pending" })
      .then((r) =>
        setBadges((b) => ({ ...b, roleRequests: (r.data || []).length })),
      )
      .catch(() => {})
