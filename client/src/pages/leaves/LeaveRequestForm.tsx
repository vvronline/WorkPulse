        ...
        try {
            if (isRange) {
                ...
                if (rangeDays.length === 0) {
                    setError("No valid days in the selected range");
                    return;
                }
                ...
                setSuccess((res.data as any)?.message || "Leave request submitted");
                setDate("");
                setReason("");
                setDuration("full");
            }
        ...
        <div className={s.card}>
            ...
            <form onSubmit={handleSubmit} className={s.form}>
                ...
                <div className={s.segmented}>
                    <button
                        type="button"
                        className={`${s.segBtn} ${!isRange ? s.segActive : ""}`}
                                ...
                                return (
                                    <button
                                        ...
                                        className={`${s.typeChip} ${
                                            leaveType === t.value ? s.typeChipActive : ""
                                        }`}
                                        style={
                                            { "--lc": t.color, "--lb": t.bg } as React.CSSProperties
                                        }
                                        onClick={() => setLeaveType(t.value)}
                                    >
                                        <span className={s.typeEmoji}>
                                            {Icon ? <Icon size={18} /> : "🗓️"}
                                        </span>
                ...
                <div className={s.field}>
                    ...
                    <div className={s.segmented}>
                        <button
                            type="button"
                            className={`${s.segBtn} ${duration === "full" ? s.segActive : ""}`}
                        ...
                        <button
                            type="button"
                            className={`${s.segBtn} ${duration === "half" ? s.segActive : ""}`}
                        ...
                        <button
                            type="button"
                            className={`${s.segBtn} ${duration === "quarter" ? s.segActive : ""}`}
