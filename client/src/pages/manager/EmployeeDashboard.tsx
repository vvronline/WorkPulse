...
export default function EmployeeDashboard({ member, onBack }: EmployeeDashboardProps) {
    ...
    useEffect(() => {
        ...
        getMemberOverview(member.id)
            .then((r) => {
                setOverview(r.data as Record<string, any>);
                setLoading(false);
            })
    ...
    return (
        <div className={s.adminPage}>
            <div className={m.employeeHeader}>
                <button onClick={onBack} className={`${sf.btnCancel} ${m["btn-back-sm"]}`}>
                    ← Back
                </button>
