                ...
                <tbody>
                    {hours.map(d => (
                        <tr key={d.date}>
                            ...
                            <td>{d.workMode === 'remote' ? <><House size={13} style={{marginRight:3,verticalAlign:'middle'}} />Remote</> : <><Building2 size={13} style={{marginRight:3,verticalAlign:'middle'}} />Office</>}</td>
                        </tr>
                    ))}
