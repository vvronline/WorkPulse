...
function getDirectionIcon(call: any, isOutgoing: boolean) {
 ...
 */
export default function CallHistory({ convId, currentUserId, onClose }: CallHistoryProps) {
                ...
                {calls.map((call) => {
                    ...
                    return (
                        <div key={call.id} className={`${s.item} ${isMissed ? s.itemMissed : ""}`}>
                            <div className={s.directionIcon}>{getDirectionIcon(call, isOutgoing)}</div>
