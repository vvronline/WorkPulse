...
export default function PlatformAccessInbox() {
    ...
    const load = useCallback(async () => {
        try {
            ...
            setItems((r.data as any)?.requests || []);
            setActive((r.data as any)?.active_session || null);
        } catch (e: any) {
...
const closeBtn: React.CSSProperties = { background: "none", border: 0, cursor: "pointer", color: "inherit" };
const listStyle: React.CSSProperties = { listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 10 };
...
const emptyMsg: React.CSSProperties = { fontSize: 12, color: "var(--text-muted)", padding: "8px 0" };
...
const th: React.CSSProperties = { padding: "8px 6px", fontWeight: 500, fontSize: 11, textTransform: "uppercase", letterSpacing: "0.04em" };
