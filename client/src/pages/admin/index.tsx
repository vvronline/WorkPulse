...
export default function AdminPanel() {
    ...
    // Org-id for structure sub-pages, resolved from the signed-in user's own
    // organization. Cross-organization structure management is intentionally
    // NOT available here - platform admins use the Platform Console (which is
    // consent-gated) instead of an in-panel org picker.
