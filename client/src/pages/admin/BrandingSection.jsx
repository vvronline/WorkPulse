 ...
 * server state.
 */
export default function BrandingSection({ canEdit }) {
    const { refresh } = useBranding();

    // Persisted server state.
    const [data, setData] = useState({ logo_url: null, accent_color: DEFAULT_ACCENT });
    ...
    const [draftLogoFile, setDraftLogoFile] = useState(null);   // File | null
    const [draftLogoPreview, setDraftLogoPreview] = useState(null); // ObjectURL
    ...
    const save = async () => {
        ...
        try {
            ...
            if (accentDirty) {
                ...
                nextRow = { ...nextRow, accent_color: row.accent_color };
            }
            setData(nextRow);
    ...
    return (
        <div className={s.wrap}>
            ...
            {/* Preview */}
            <div className={s.previewBlock} style={{ '--preview-accent': draftAccent }}>
