...
interface WorkBreakChartProps {
    labels: string[];
    floorHours: number[];
    breakHours: number[];
}

export default function WorkBreakChart({ labels, floorHours, breakHours }: WorkBreakChartProps) {
    ...
    const barOptions: any = {
        ...
        plugins: {
            ...
            tooltip: {
                ...
                callbacks: {
                    label: (ctx: any) =>
                        `${ctx.dataset.label}: ${ctx.parsed.y.toFixed(1)} hrs`,
                },
            },
        },
        scales: {
    ...
    return (
        <div className={s["chart-card"]}>
            <h3 style={{ display: "flex", alignItems: "center", gap: "0.4rem" }}>
                <BarChart3 size={17} /> Daily Work vs Break Time
            </h3>
