...
export function TimeDistributionChart({ totalFloor, totalBreak }: TimeDistributionChartProps) {
    ...
    const doughnutOptions: any = {
        ...
        plugins: {
            ...
            tooltip: {
                ...tooltipStyle,
                callbacks: {
                    label: (ctx: any) => `${ctx.label}: ${formatTime(ctx.parsed)}`,
                },
            },
        },
    };
    ...
    return (
        <div className={s["chart-card"]}>
            <h3 style={{ display: "flex", alignItems: "center", gap: "0.4rem" }}>
                <PieChart size={17} /> Time Distribution
            </h3>
...
export function WorkModeChart({ officeDays, remoteDays }: WorkModeChartProps) {
    return (
        <div className={s["chart-card"]}>
            <h3 style={{ display: "flex", alignItems: "center", gap: "0.4rem" }}>
                <Building2 size={17} /> Office vs Remote
            </h3>
            <Doughnut
                data={{
                ...
                options={
                    {
                        ...
                        plugins: {
                            ...
                            tooltip: {
                                ...tooltipStyle,
                                callbacks: {
                                    label: (ctx: any) => `${ctx.label}: ${ctx.parsed} days`,
                                },
                            },
                        },
                    } as any
