...
interface OvertimeRequestFormProps {
    onSubmitted: (updatedList: any[]) => void;
}
 ...
 */
export default function OvertimeRequestForm({ onSubmitted }: OvertimeRequestFormProps) {
    const [otDate, setOtDate] = useState("");
    const [otHours, setOtHours] = useState("");
    const [otReason, setOtReason] = useState("");
    const [otLoading, setOtLoading] = useState(false);
    const [otError, setOtError] = useAutoDismiss("") as [string, (v: string) => void];
    const [otSuccess, setOtSuccess] = useAutoDismiss("") as [string, (v: string) => void];
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setOtSuccess((res.data as any).message || "Overtime request submitted");
            setOtDate("");
            setOtHours("");
            setOtReason("");
