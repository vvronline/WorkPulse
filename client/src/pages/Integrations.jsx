...
//      `GitHubIntegration.jsx` for the pattern). It receives an
...
export default function Integrations() {
    ...
    // ─── Detail view ────────────────────────────────────────────────────
    if (selected) {
        const Detail = selected.component;
        return (
            <div style={styles.page}>
                ...
                <Detail
                    onStatusChange={(s) =>
                        setStatusById(prev => ({ ...prev, [selected.id]: s }))
                    }
                />
            </div>
        );
...
function ProviderCard({ provider, liveStatus, onOpen }) {
