                        ...
                        <div>
                            ...
                            <div
                                style={{
                                    fontSize: 13,
                                    fontWeight: 500,
                                    color: bankDetails.is_verified ? "var(--success)" : "var(--warning)",
                                }}
                            >
                        ...
                        >
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e) =>
                                        setBankForm((f) => ({ ...f, ifsc_code: e.target.value.toUpperCase() }))
                                    }
                        ...
                        <tbody>
                            {slips.map((slip, idx) => (
                                <tr
                                    key={slip.id}
                                    style={{
                                        borderBottom: idx < slips.length - 1 ? "1px solid var(--border)" : "none",
