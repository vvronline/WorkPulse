...
export default function CustomFieldsSection({ canEdit = true }) {
    const { workItemTypes } = useAgileConfig();
    const { refresh: refreshFields } = useCustomFields();
    const [rows, setRows] = useState([]);
    const [loading, setLoading] = useState(true);
    const [error, setError] = useState('');
    const [saving, setSaving] = useState(false);
    const [editingId, setEditingId] = useState(null); // null = closed, 'new' = new, number = edit
