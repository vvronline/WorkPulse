...
export default function PlanManagement() {
    ...
    useEffect(() => {
        getPlanCatalog()
            .then(r => {
                ...
                setFeatureKeys(data.feature_keys || Object.keys(data.feature_labels || {}));
            })
    ...
    const updatePlan = (key: string, field: string, value: any) => {
        setPlans((p: any) => ({ ...p, [key]: { ...p[key], [field]: value } }));
    };

    const updatePlanFeature = (planKey: string, featureKey: string, value: boolean) => {
        setPlans((p: any) => ({
            ...p,
