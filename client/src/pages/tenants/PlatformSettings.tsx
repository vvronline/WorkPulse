...
export default function PlatformSettings() {
    ...
    const [deleteModal, setDeleteModal] = useState<{ open: boolean; id: any }>({ open: false, id: null });
    ...
    const updateDraft = (key: string, value: any) => setConfigDraft((d: any) => ({ ...d, [key]: value }));
    const configChanged = (keys: string[]) => config && configDraft && keys.some(k => config[k] !== configDraft[k]);
