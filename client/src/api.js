...
export const suspendTenant = (id, reason, password) => API.put(`/admin/tenants/${id}/suspend`, { reason, password });
export const reactivateTenant = (id) => API.put(`/admin/tenants/${id}/reactivate`);
export const deleteTenantApi = (id, hard, password) => API.delete(`/admin/tenants/${id}`, { params: { hard }, data: { password } });
