...
interface TimeTrackingBlockProps {
    onRemove?: () => void;
}

export default function TimeTrackingBlock({ onRemove }: TimeTrackingBlockProps) {
    ...
    const modeLabels: Record<string, string> = { office: "🏢 Office", remote: "🏠 Remote", hybrid: "🔄 Hybrid" };
