...
interface PageLinkPickerProps {
    pages: any[];
    position?: { top: number | string; left: number | string } | null;
    onPick: (page: any) => void;
    onCreate?: (title: string) => void;
    onClose: () => void;
}

export default function PageLinkPicker({ pages, position, onPick, onCreate, onClose }: PageLinkPickerProps) {
