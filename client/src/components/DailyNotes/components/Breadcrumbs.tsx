...
import { getFolderPath, getPageAncestors, type NotePage, type NoteFolder } from "../notesUtils";
import s from "./Breadcrumbs.module.css";

interface BreadcrumbsProps {
    activePage: NotePage | null | undefined;
    pages: NotePage[];
    folders: NoteFolder[];
...
export default function Breadcrumbs({ activePage, pages, folders, onSelectPage, onSelectFolder }: BreadcrumbsProps) {
