...
export default function PageSwitcherPopover({ store, onClose }: PageSwitcherPopoverProps) {
    const {
    ...
    const closeAndSelect = (id: any) => {
        handleSelectPage(id);
        onClose();
    };

    const folderName = (fid: any) => {
                ...
                {searching ? (
                    ...
                    <div className={s.folderListWrap}>
                        <FolderTree
                            ...
                            onSelectPage={(id: any) => closeAndSelect(id)}
                            onNewFolder={(parentId: any, name: any) => handleNewFolder(parentId, name)}
                            onNewPage={(folderId: any, title: any) => { handleNewPage(folderId, title); onClose(); }}
