...
import { getBacklinks, formatDate, type NotePage } from "../notesUtils";
...
export default function BacklinksPanel({ activePage, pages, onSelectPage }: BacklinksPanelProps) {
