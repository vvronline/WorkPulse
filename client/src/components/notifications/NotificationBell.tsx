...
const TYPE_ICON: Record<string, React.ReactNode> = {
    ...
    leave: <ClipboardList size={14} />,
    task: <FileText size={14} />,
    approval: <CheckCircle2 size={14} />,
    meeting_invite: <Video size={14} />,
};
...
export default function NotificationBell() {
    ...
    const handleDelete = async (e: React.MouseEvent, notifId: number | string) => {
        e.stopPropagation();
        try {
                            ...
                            notifications.map((n) => (
                                ...
                                >
                                    <span className="notif-icon">
                                        {(n.type && TYPE_ICON[n.type]) || DEFAULT_ICON}
                                    </span>
