...
type Glyph = "check" | "minus" | "clock" | "ring" | "dot";
...
export default function ProfileMenu() {
    ...
    const { workState, workMode } = useWorkState() as any;
    ...
    const renderStatusGlyph = (glyph: Glyph, className: string) => {
        if (glyph === "check") {
            return (
                <svg className={className} viewBox="0 0 10 10" fill="none" aria-hidden="true">
                    <path
                        d="M2.1 5.1L4.2 7L7.9 3.3"
                        stroke="currentColor"
                        strokeWidth="1.7"
                        strokeLinecap="round"
    ...
    return (
        <div className={s["profile-section"]} ref={profileRef}>
            ...
            >
                ...
                <svg
                    className={`${s["profile-chevron-icon"]} ${profileOpen ? s.open : ""}`}
                    width="12"
                    height="12"
                    viewBox="0 0 12 12"
                    fill="none"
                    ...
                    <div className={s["profile-dropdown-body"]}>
                        ...
                        {avatarUrl && (
                            ...
                            >
                                <span className={s["dd-item-icon"]}>
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                                        <path
                                            d="M4 6h8l-.7 7.3a1 1 0 01-1 .7H5.7a1 1 0 01-1-.7L4 6zM6 6V4a1 1 0 011-1h2a1 1 0 011 1v2M3 6h10"
                                            stroke="currentColor"
                                            strokeWidth="1.2"
                                            strokeLinecap="round"
                                            strokeLinejoin="round"
                            ...
                            <span className={s["dd-item-icon"]}>
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                                    {theme === "dark" ? (
                                        ...
                                        <path
                                            d="M13.36 10.06A6 6 0 015.94 2.64 6 6 0 1013.36 10.06z"
                                            stroke="currentColor"
                                            strokeWidth="1.2"
                                            strokeLinecap="round"
                                            strokeLinejoin="round"
                        ...
                        {window.electronAPI && (
                            <button
                                ...
                                onClick={() => {
                                    setProfileOpen(false);
                                    window.dispatchEvent(new Event("workpulse-check-update"));
                                }}
                            >
                                <span className={s["dd-item-icon"]}>
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                                        <path
                                            d="M14 8a6 6 0 1 1-4.15-5.7"
                                            stroke="currentColor"
                                            strokeWidth="1.2"
                                            strokeLinecap="round"
                                            strokeLinejoin="round"
