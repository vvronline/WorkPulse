...
export default function NotificationSoundsModal({ onClose }: NotificationSoundsModalProps) {
    const { prefs, updatePrefs, resetPrefs, preview } = useNotificationPrefs() as any;
            ...
            <div className={s.modal} role="dialog" aria-modal="true" aria-labelledby="ns-title">
                <div className={s.header}>
                    <div className={s.titleWrap}>
                        ...
                        <h2 id="ns-title" className={s.title}>
                            Notification sounds
                        </h2>
                    </div>
                ...
                <div className={s.body}>
                        ...
                        <div className={s.muteCardLeft}>
                            ...
                            <div>
                                ...
                                <div className={s.muteHint}>
                                    Disables every ringtone, message and mention sound until turned
                                    off.
                                </div>
                            </div>
                        </div>
                    ...
                    <div className={s.section}>
                        ...
                        <ToneRow
                            ...
                            onChange={(id) => {
                                updatePrefs({ ringtone: id });
                                preview("ringtone", id, prefs.ringtoneVolume);
                            }}
                            volume={prefs.ringtoneVolume}
                            onVolumeChange={(v) => updatePrefs({ ringtoneVolume: v })}
                            onPreview={() =>
                                preview("ringtone", prefs.ringtone, prefs.ringtoneVolume)
                            }
                            disabled={muted}
                        />
                        <ToneRow
                            ...
                            onChange={(id) => {
                                updatePrefs({ outgoingTone: id });
                                preview("outgoing", id, prefs.outgoingVolume);
                            }}
                            volume={prefs.outgoingVolume}
                            onVolumeChange={(v) => updatePrefs({ outgoingVolume: v })}
                            onPreview={() =>
                                preview("outgoing", prefs.outgoingTone, prefs.outgoingVolume)
                            }
                            disabled={muted}
                        />
                    </div>
                    ...
                    <div className={s.section}>
                        ...
                        <ToneRow
                            ...
                            onChange={(id) => {
                                updatePrefs({ messageTone: id });
                                preview("message", id, prefs.messageVolume);
                            }}
                            volume={prefs.messageVolume}
                            onVolumeChange={(v) => updatePrefs({ messageVolume: v })}
                            onPreview={() =>
                                preview("message", prefs.messageTone, prefs.messageVolume)
                            }
                            disabled={muted}
                        />
                        <ToneRow
                            ...
                            onChange={(id) => {
                                updatePrefs({ mentionTone: id });
                                preview("mention", id, prefs.mentionVolume);
                            }}
                            volume={prefs.mentionVolume}
                            onVolumeChange={(v) => updatePrefs({ mentionVolume: v })}
                            onPreview={() =>
                                preview("mention", prefs.mentionTone, prefs.mentionVolume)
                            }
                            disabled={muted}
                        />
                        <ToneRow
                            ...
                            onChange={(id) => {
                                updatePrefs({ reactionTone: id });
                                preview("reaction", id, prefs.reactionVolume);
                            }}
                            volume={prefs.reactionVolume}
                            onVolumeChange={(v) => updatePrefs({ reactionVolume: v })}
                            onPreview={() =>
                                preview("reaction", prefs.reactionTone, prefs.reactionVolume)
                            }
                            disabled={muted}
                        />
                    </div>
                        ...
                        <label className={s.checkboxRow}>
                            ...
                            <span>
                                ...
                                <span className={s.checkboxHint}>
                                    By default, sounds only play when the window is in the
                                    background.
                                </span>
                            </span>
                        </label>
