 ...
 * @param {Object} body
 * @param {'available'|'busy'|'dnd'|'brb'|null} body.status
 * @param {string|null} [body.message]
 * @param {string|null} [body.messageExpiresAt]  ISO 8601
 */
export const setMyStatus = (body) => API.put('/me/status', body);

/** PUT /api/me/status/presence-preference  body: { preference: 'auto' | 'invisible' } */
export const setPresencePreference = (preference) =>
